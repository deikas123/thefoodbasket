        ...
        <div className="flex gap-2 p-4">
          {categories.map((category) => (
            <Link
              ...
              to={category.href}
              className={cn(
                "flex flex-col items-center justify-center min-w-[70px] h-16 rounded-lg transition-all duration-200",
                "bg-muted/50 hover:bg-muted hover:scale-105 active:scale-95"
              )}
            >
