...
// Simple email sending without Resend (log for now)
  ...
  try {
    ...
    for (let i = 0; i < profiles.length; i += batchSize) {
      ...
      const emailPromises = batch.map(async (profile) => {
        ...
        const emailSubject = `🔥 ${discountPercentage}% OFF - ${flashSaleName} Starts Now!`;
        const emailHtml = `
          <!DOCTYPE html>
          <html>
          <head>
          ...
          <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #fff; border-radius: 12px; padding: 30px; border: 1px solid #e5e7eb;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="https://friendly-food-gateway.lovable.app/flash-sales" 
